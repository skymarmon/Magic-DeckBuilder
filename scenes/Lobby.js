export default class Lobby extends Phaser.Scene {
    ...
    create() {
        ...
        const button_start = this.add.image(baseX - 440, baseY - 230, 'button_start').setScale(0.7 * scale).setAlpha(this.fromLicense ? 0 : 1).setInteractive();
        ...
        const button_research = this.add.image(baseX - 270, baseY - 120, 'button_research').setScale(0.5 * scale).setAlpha(this.fromLicense ? 0 : 1).setInteractive();
        ...
        const button_record = this.add.image(baseX - 110, baseY - 120, 'button_record').setScale(0.5 * scale).setAlpha(this.fromLicense ? 0 : 1).setInteractive();
